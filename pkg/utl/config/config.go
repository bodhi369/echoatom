...
type Configuration struct {
	...
	Casbinmode *Casbinmode  `yaml:"casbinmode,omitempty"`
}
...
// Casbinmode holds casbin configuration details
type Casbinmode struct {
	ModeText string `yaml:"mode_text,omitempty"`
}
